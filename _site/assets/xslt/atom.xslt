...
<xsl:template match="/atom:feed">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000/feeling-responsive" class="icon-tree"> The Carbon Shifters</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/feeling-responsive/" title="The Carbon Shifters – Using gasification as a climate remedy">
				<img src="http://localhost:4000/feeling-responsive/assets/img/logo.png" alt="The Carbon Shifters – Using gasification as a climate remedy">
			</a>
